...
collector:
  ...
  api_key: ""
  headers: {}               # Extra OTLP request headers; values stringified
  timeout: 5000
  protocol: http            # http | grpc
  metrics: { enabled: true }
  traces: { enabled: true }
  logs: { enabled: true, local: true, path: "~/.nio/audit.jsonl", max_size_mb: 100 }
  content_limits: {}        # Per-kind UTF-8 byte caps for conversation content records
                            # (thinking / text / user_prompt / tool_input / tool_output; 0 = uncapped)
```
