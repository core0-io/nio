...
- 7fa8a94: **Docs: clarify per-phase deny-threshold short-circuit; drop stale collector probe claims.**
...
- 7fa8a94: **`/nio doctor` no longer probes the OTLP collector endpoint.**
...
- 6c19410: **MCP tool calls are now first-class actions through the guard pipeline.**
