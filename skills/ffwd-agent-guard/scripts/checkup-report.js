...
<header class="shrink-0 flex justify-between items-center px-4 sm:px-6 py-3 bg-[#10141a] shadow-[0px_8px_24px_rgba(0,0,0,0.3)]">
  ...
  <div class="flex items-center gap-2 sm:gap-3 header-btns">
    ...
    <a href="https://github.com/core0-io/ffwd-agent-guard" target="_blank" class="hidden sm:flex items-center gap-1 px-2.5 py-1.5 bg-[#262a31] border border-[#3a4a3f]/30 rounded-lg text-[11px] font-semibold text-[#849588] hover:text-[#dfe2eb] hover:border-[#849588]/50 transition-all no-underline">
